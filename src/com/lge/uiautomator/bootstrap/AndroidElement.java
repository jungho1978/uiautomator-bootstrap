...
import com.lge.uiautomator.bootstrap.utils.UnicodeEncoder;
import com.lge.uiautomator.exceptions.InvalidCoordinatesException;
import com.lge.uiautomator.exceptions.NoAttributeFoundException;
...
public class AndroidElement {
    ...
    public AndroidElement(final String id, final UiObject el) {
        this.el = el;
        this.id = id;
    }
    ...
    public boolean performMultiPointerGesture(PointerCoords[]... touches) {
        try {
            if (API_18) {
                // The compile-time SDK expects the wrong arguments, but the
                // runtime
