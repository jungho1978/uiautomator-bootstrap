...
/**
 * For parsing strings that create UiScrollable objects into UiScrollable
 * objects
 */
public class UiScrollableParser {
    ...
    /*
     * Returns whether or not the input string is trying to instantiate a
     * UiScrollable, and use its methods
     */
    ...
    /*
     * You can start a UiScrollable like:
     * "new UiScrollable(UiSelector).somemethod()" or
     * "Uiscrollable(UiSelector).somemethod()"
     */
    ...
    /*
     * consume UiScrollable constructor argument: parens surrounding a
     * uiSelector. eg - "(new UiSelector().scrollable(true))" initialize the
     * UiScrollable object for this parser
     */
    ...
    /*
     * consume [a-z]* then an open paren, this is our methodName consume .* and
     * count open/close parens until the original open paren is close, this is
     * our argument
     */
            ...
            if (method.getGenericReturnType() == UiScrollable.class || scrollIntoView) {
                ...
                try {
                    if (scrollIntoView) {
                        ...
                        // scrollIntoView must return the object if it's already
                        // in view.
                        // without the exists check, the parser will error
                        // because there's no scrollable.
                        if (uiObject.exists()) {
                            return;
                        }
                    ...
                    // Ignoring UiObjectNotFoundException as this handled during
                    // actual find.
                    ...
                    Logger.error(e.getCause().toString()); // we're only
                                                           // interested in the
                                                           // cause.
                                                           // InvocationTarget
                                                           // wraps the
