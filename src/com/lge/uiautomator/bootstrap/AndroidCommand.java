...
public class AndroidCommand {
    ...
    /**
     * Get the {@link AndroidElement element} this command is to operate on
     * (must provide the "elementId" parameter).
     *
     * @return {@link AndroidElement}
     * @throws JSONException
     */
     ...
     *
     * @param stringType The string of the type (i.e. "shutdown" or "action")
