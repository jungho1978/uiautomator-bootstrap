...
import com.lge.uiautomator.bootstrap.utils.API;

/**
 *
 * The AccessibilityNodeInfoDumper in Android Open Source Project contains a lot
 * of bugs which will stay in old android versions forever. By coping the code
 * of the latest version it is ensured that all patches become available on old
 * android versions.
 *
 * down ported bugs are e.g. { @link
