...
import com.lge.uiautomator.bootstrap.OrientationEnum;
...
public class Orientation extends CommandHandler {
    ...
    private AndroidCommandResult getRotation() {
        ...
        final OrientationEnum currentRotation = OrientationEnum.fromInteger(d.getDisplayRotation());
     ...
     */
    private AndroidCommandResult handleRotation(final String orientation) throws RemoteException, InterruptedException {
        final UiDevice d = UiDevice.getInstance();
