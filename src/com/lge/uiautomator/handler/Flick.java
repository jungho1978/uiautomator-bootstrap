...
public class Flick extends CommandHandler {
    ...
    private Point calculateEndPoint(final Point start, final Integer xSpeed, final Integer ySpeed) {
    ...
    public AndroidCommandResult execute(final AndroidCommand command) throws JSONException {
        ...
        Logger.debug("Flicking from " + start.toString() + " to " + end.toString() + " with steps: " + steps.intValue());
        final boolean res = d.swipe(start.x.intValue(), start.y.intValue(), end.x.intValue(), end.y.intValue(), steps.intValue());
