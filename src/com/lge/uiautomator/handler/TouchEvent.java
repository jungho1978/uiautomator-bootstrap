...
public abstract class TouchEvent extends CommandHandler {
    ...
    public AndroidCommandResult execute(final AndroidCommand command) throws JSONException {
        ...
        try {
            ...
            // isElementCommand doesn't check to see if we actually have an
            // element
    ...
    /**
     * Variables persist across executions. initialize must be called at the
     * start of execute.
     **/
    ...
    protected void printEventDebugLine(final String methodName, final Integer... duration) {
        ...
        Logger.debug("Performing " + methodName + " using element? " + isElement + " x: " + clickX + ", y: " + clickY + extra);
    }
}
