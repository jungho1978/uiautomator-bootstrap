...
public class ScrollTo extends CommandHandler {
    ...
    public AndroidCommandResult execute(final AndroidCommand command) throws JSONException {
        ...
        try {
            ...
            if (direction.toLowerCase().contentEquals("horizontal") || view.getClassName().contentEquals("android.widget.HorizontalScrollView")) {
            ...
            UiObject listViewItem = view.getChildByInstance(new UiSelector().text(text), 0);
